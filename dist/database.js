...
(() => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const db = yield mongoose_1.default.connect(`mongodb+srv://${keysEnv.DB_USER}:${keysEnv.DB_PASSWORD}@cluster0.v8qqmsf.mongodb.net/${keysEnv.DB_NAME}?retryWrites=true&w=majority`);
        console.log('');
